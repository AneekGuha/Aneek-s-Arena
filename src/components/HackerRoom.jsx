...
export function HackerRoom(props) {
  ...
  const [monitorTxt, screenTxt] = useTexture([
    ...
    '/textures/desk/test.jpg',
  ]);


  const memoTextures = useMemo(() => ({ monitorTxt, screenTxt }), [monitorTxt, screenTxt]);
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.screen_screens_0.geometry} material={materials.screens}>
        <meshMatcapMaterial map={memoTextures.screenTxt} />
      </mesh>
      <mesh geometry={nodes.table_table_mat_0_2.geometry} material={materials.computer_mat}>
        <meshMatcapMaterial map={memoTextures.monitorTxt} />
      </mesh>
